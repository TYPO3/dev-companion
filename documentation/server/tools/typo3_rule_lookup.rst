...
.. code-block:: text
    ...
    - Rebasing a Stale Patch: 1. What Main Landed on These Paths, 2. Whether a Fix Survived the Rewrite, 3. Removed Members That Still Have Callers, 4. The Suites Covering What It Rewrote, The Committed JavaScript
