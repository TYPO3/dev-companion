 ...
 * Configuration/Fluid/Namespaces.php that returns prefix => list of PHP
 * namespaces, and the core merges them across all active packages.
 *
 * A parser reads the files, and nothing includes them, the same rule as for the
 * icon registry. They are ordinary PHP that would run in this process. Earlier
 * TYPO3 versions register these namespaces in TYPO3_CONF_VARS and have no such
 * file.
 */
