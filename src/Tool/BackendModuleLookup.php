    ...
    public static function outputSchema(): array
    {
        return Schema::installationAnswer([
            ...
            'checked' => Schema::listOf(Schema::object([
                ...
                'parentRegistered' => Schema::nullable(['type' => 'boolean', 'description' => 'Whether this installation has a module under that identifier. Null where the entry names no parent, and null where the value was not a plain string in the file.']),
                'iconIdentifier' => Schema::string('The icon it names. Empty where it names none.'),
                'iconRegistered' => Schema::nullable(['type' => 'boolean', 'description' => 'Whether the registry here holds that identifier. Null where the entry names no icon, and null where the value is not a plain string.']),
