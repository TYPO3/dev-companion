    ...
    public static function outputSchema(): array
    {
        return Schema::installationAnswer([
            ...
            'entries' => Schema::listOf(Schema::object([
                ...
                'title' => Schema::string(),
                'removal' => Schema::string('The version a Deprecation states the deprecated thing stops working in — what an upgrade decides on. Empty on the other three types, and on a deprecation whose entry states none. That is most of a major and does not mean "no removal planned"; removalRule answers it there.'),
