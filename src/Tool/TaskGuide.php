...
final class TaskGuide extends ReadOnlyTool
{
    ...
    public static function outputSchema(): array
    {
        return Schema::object([
            ...
            'targetVersion' => ['type' => ['integer', 'null'], 'description' => 'The TYPO3 major this repository runs — stated by the caller, or read from the installation. Null means no version filtered anything. Where the repository serves several majors, targetVersions is what the answer holds for.'],
